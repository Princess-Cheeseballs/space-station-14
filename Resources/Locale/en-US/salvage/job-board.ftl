...
salv-job-board-name-BountySalvageOrePhoron = Phoron (Ore)
...
bounty-description-salvage-ore-phoron = We need a shipment of phoron ore to send over to the research station. Please provide us with some so that we can continue our testing. It can come from any source.
